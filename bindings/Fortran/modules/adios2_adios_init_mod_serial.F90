...
# define ADIOS2_MODULE_PREFIX module
#else
# define ADIOS2_MODULE_PREFIX
#endif
...
contains
    ...
    ADIOS2_MODULE_PREFIX subroutine adios2_init_serial( &
    ...
    ADIOS2_MODULE_PREFIX subroutine adios2_init_debug_serial(adios, ierr)
        type(adios2_adios), intent(out) :: adios
        integer, intent(out) :: ierr
    ...
    ADIOS2_MODULE_PREFIX subroutine adios2_init_config_serial( &
    ...
    ADIOS2_MODULE_PREFIX subroutine adios2_init_config_debug_serial( &
