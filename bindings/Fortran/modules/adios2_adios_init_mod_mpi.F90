...
contains
    ...
    ADIOS2_MODULE_PREFIX subroutine adios2_init_mpi( &
    ...
    ADIOS2_MODULE_PREFIX subroutine adios2_init_debug_mpi(adios, comm, ierr)
        type(adios2_adios), intent(out) :: adios
        integer, intent(in) :: comm
        integer, intent(out) :: ierr
    ...
    ADIOS2_MODULE_PREFIX subroutine adios2_init_config_mpi( &
    ...
    ADIOS2_MODULE_PREFIX subroutine adios2_init_config_debug_mpi( &
